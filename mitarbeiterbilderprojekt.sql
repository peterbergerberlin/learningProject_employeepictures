...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 11. Jun 2020 um 16:06
...
CREATE TABLE `mitarbeiterbilder` (
  ...
  `arbeitsplatz` varchar(100) NOT NULL,
...
INSERT INTO `mitarbeiterbilder` (`id`, `userid`, `vorname`, `nachname`, `position`, `arbeitsplatz`, `bilddateiname`) VALUES
(1, 1, 'Peter', 'Berger', 'Frontend Developer', 'Gebäude 2, Raum 208', '1_peter_berger.jpg'),
(2, 2, 'Horst', 'Schlaemmer', 'Backend Developer', 'Gebaeude 2, Raum 207', '2_horst_schlaemmer.jpg'),
(3, 3, 'Bernd', 'Stromberg', 'Chef vom Dienst', 'Gebaeude 2, Raum 310', '3_bernd_stromberg.jpg'),
...
(21, 6, 'Jade', 'Raymond', 'Gamedeveloper', 'Gebäude 2, Raum 5c', 'jaderaymond-1200x900.jpg');
